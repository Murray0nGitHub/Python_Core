...
#You will see a random.seed(int(input())) line in sample code.
#It initializes the pseudorandom number generator and, in this case, ensures functionality of test cases.
